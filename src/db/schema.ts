...
export const titles = pgTable('titles', {
  ...
  featuredUpdatedAt: timestamp('featured_updated_at'),
...
/**
 * affiliate_links — platform-specific purchase/streaming links per title.
 * Supports both manual entries and auto-generated links.
 */
export const affiliateLinks = pgTable('affiliate_links', {
  ...
  titleId: integer('title_id')
    .references(() => titles.id)
    .notNull(),
  platform: varchar('platform', { length: 50 }).notNull(), // 'amazon', 'crunchyroll', 'panini', etc.
  url: varchar('url', { length: 2000 }).notNull(),
  label: varchar('label', { length: 200 }),                // Display text override
