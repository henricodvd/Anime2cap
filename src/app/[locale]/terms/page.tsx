  ...
  return (
    <div className="max-w-3xl mx-auto px-6 pt-32 sm:pt-40 pb-20">
      <div className="glass-panel rounded-3xl p-8 md:p-12 border border-brand-cherry/10">
        <h1 className="font-heading text-xl sm:text-4xl font-bold mb-2 text-paper uppercase italic leading-tight">{t('title')}</h1>
        ...
        <div className="space-y-12 text-paper/75 leading-relaxed text-lg font-body">
          <section>
            <h2 className="text-paper font-heading text-xl sm:text-2xl font-bold mb-4 uppercase italic">{t('sec1Title')}</h2>
            <p>{t('sec1Content')}</p>
          </section>
